...
// let db = null;
// const initializeDBAServer = async () => {
//   try {
//     db = await open({
//       filename: dbPath,
//       driver: sqlite3.Database,
...
// //   const player = await db.get(getPlayersQry);
